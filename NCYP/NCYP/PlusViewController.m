...
@synthesize tableview,filedListArray,BgImg,appDelegate,backBtn,tabmenuView,refreshBtn,searchBtn,petrolBtn,changeLangBtn,bannerImg,tempLbl,usdpriceLbl,europriceLbl,poundpriceLbl,imageArray,bannerAsyncimg,bannerImgBtn;
...
- (void)viewDidLoad {
    ...
    filedListArray=[[NSMutableArray alloc]initWithObjects:@"Commercials",@"Videos",@"Suggest New Location",@"Daily Horoscope",@"Did you know?",@"Contact us",@"Settings",@"About This Software", nil];
    
    imageArray=[[NSMutableArray alloc]initWithObjects:@"commercials.png",@"videos.png",@"suggest_new_location.png",@"daily_horoscope.png",@"did_you_know.png",@"contact_us.png",@"settings.png",@"about_this_software.png", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    testNameLbl.text=[filedListArray objectAtIndex:indexPath.row];
    ...
    subNameLbl.text=[filedListArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.row==0) {
        CommercialViewController *commerical=[[CommercialViewController alloc] initWithNibName:@"CommercialViewController" bundle:nil];
        [self.navigationController pushViewController:commerical animated:YES];
    ...
    if (indexPath.row==2) {
        SuggestNewLocationViewController *suggest=[[SuggestNewLocationViewController alloc] initWithNibName:@"SuggestNewLocationViewController" bundle:nil];
        [self.navigationController pushViewController:suggest animated:YES];
    }
    if (indexPath.row==3) {
        DailyHoroscopeViewController *horoscope=[[DailyHoroscopeViewController alloc] initWithNibName:@"DailyHoroscopeViewController" bundle:nil];
        [self.navigationController pushViewController:horoscope animated:YES];
    }

    if (indexPath.row==5) {
        SettingViewController *setting=[[SettingViewController alloc] initWithNibName:@"SettingViewController" bundle:nil];
       appDelegate.plusSettingTXTArray=[[NSMutableArray alloc]initWithObjects:@"Call us",@"Email us", nil];
        
        appDelegate.plusSettingIMGArray=[[NSMutableArray alloc]initWithObjects:@"call_us.png",@"email_us.png", nil];
        [self.navigationController pushViewController:setting animated:YES];
    }
    if (indexPath.row==6) {
        SettingViewController *setting=[[SettingViewController alloc] initWithNibName:@"SettingViewController" bundle:nil];
        appDelegate.plusSettingTXTArray=[[NSMutableArray alloc]initWithObjects:@"Choose Theme",@"Background", nil];
        
        appDelegate.plusSettingIMGArray=[[NSMutableArray alloc]initWithObjects:@"choose_theme.png",@"background.png", nil];
        [self.navigationController pushViewController:setting animated:YES];
    }
}
