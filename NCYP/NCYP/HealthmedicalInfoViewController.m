//
//  HealthmedicalInfoViewController.m
//  NCYP
//
...
@interface HealthmedicalInfoViewController ()

@end

@implementation HealthmedicalInfoViewController
...
{
    return [appDelegate.healthmedInfoimgArray count];
}
...
//[cell.contentView addSubview:subNameLbl];
    ...
    NSString *imgStr=[appDelegate.healthmedInfoimgArray objectAtIndex:indexPath.row];
