//
//  HealthMedicalDetalisViewController.m
//  NCYP
//
...
@interface HealthMedicalDetalisViewController ()

@end

@implementation HealthMedicalDetalisViewController
...
{
    return [appDelegate.healthmedidetalisimgArray count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
   ...
   // [cell.contentView addSubview:subNameLbl];
    ...
    NSString *imgStr=[appDelegate.healthmedidetalisimgArray objectAtIndex:indexPath.row];
