...
@synthesize tableview,filedListArray,BgImg,appDelegate,backBtn,tabmenuView,refreshBtn,searchBtn,petrolBtn,changeLangBtn,bannerImg,tempLbl,usdpriceLbl,europriceLbl,poundpriceLbl,imagArray,bannerAsyncimg,bannerImgBtn;
...
- (void)viewDidLoad {
    ...
    filedListArray=[[NSMutableArray alloc]initWithObjects:@"Ambulance",@"Police",@"Fire Station",@"Forest Fire",@"Coast Guard",@"Electricity Board",@"Pharmacies on Call",@"Petrol Station", nil];
    imagArray=[[NSMutableArray alloc]initWithObjects:@"ambulance.png",@"police.png",@"fire_station.png",@"forest_fire.png",@"coast_guard.png",@"elektricity_board.png",@"pharmacies_on_call.png",@"petrol_station.png", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *imgStr=[imagArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==6) {
        EmergencyDetalisViewController *detalis=[[EmergencyDetalisViewController alloc] initWithNibName:@"EmergencyDetalisViewController" bundle:nil];
        appDelegate.emergencyTxtArray=[[NSMutableArray alloc]initWithObjects:@"Nearby",@"Kyrenia",@"Nicosia",@"Famagusta",@"Morphou",@"Trikomo", nil];
        appDelegate.emergencyImagArray=[[NSMutableArray alloc]initWithObjects:@"nearby.png",@"kyrenia.png",@"nicosia.png",@"famagusta.png",@"morphou.png",@"trikomo.png", nil];
