...
@synthesize tableview,NewArraylist,BgImg,appDelegate,backBtn,tabmenuView,refreshBtn,searchBtn,petrolBtn,changeLangBtn,bannerImgBtn,tempLbl,usdpriceLbl,europriceLbl,poundpriceLbl,activityIndicator,bannerAsyncimg,backidStr,characters,searchString,currentElement,itemStr,itemfound,currentElementData,itemVO;
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)newsAction{
    ...
    NSString *urlString;
        urlString = [[NSString alloc]initWithFormat:@"http://www.kpdailynews.com/rss.xml?cat=35"];
...
-(IBAction)backAction{
    if (appDelegate.ishomenewBtnclick) {
        ...
        appDelegate.ishomenewBtnclick=false;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ItemVO *itemvo=[NewArraylist objectAtIndex:indexPath.row];
